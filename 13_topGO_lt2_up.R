...
# plot results
pdf(file = "12_GO_terms/go_lt2_bp_up.pdf", width = 8.5, height = 6)
bgc.bp.result$plot
dev.off()
...
# plot results
pdf(file = "12_GO_terms/go_lt2_mf_up.pdf", width = 8.5, height = 6)
bgc.mf.result$plot
dev.off()
...
# plot results
pdf(file = "12_GO_terms/go_lt2_cc_up.pdf", width = 8.5, height = 5)
bgc.cc.result$plot
dev.off()
...
# save results as TSV
write.table(x = final.df, file = "12_GO_terms/go_lt2_up.tsv",
            append = F, quote = F,
